...
con = sqlite3.Connection('hotel.db')
cur = con.cursor()
...
#chilanka
Label(sroot,text="Hotel Room Management System ",font='Timesnewroman 40 ',bg='white',fg='black').place(x=535,y=10)
Label(sroot,text="Made by -",font='Timesnewroman 40 ',bg='white',fg='black').place(x=535,y=90)
Label(sroot,text="NAVEEN RAJU.K",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="naveenkanagaraju1901@gmail.com",font='Timesnewroman 35',bg='white',fg='grey').place(x=535,y=270)
Label(sroot,text="7094240070",font='Timesnewroman 35',bg='white',fg='grey').place(x=535,y=450)
#----------- main project------------------------------------------------------------------------------------------------------------------
def mainroot():
	#sroot.destroy()
	root = Tk()
	...
	root.title("Made with love by Naveen Raju")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	tf_label = Label(top_frame,text='Hotel Room Management System',font='msserif 33',fg='black',bg='gray89',height=70)
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by NAVEEN RAJU',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. NAVEEN RAJU.K",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Ms. SHARUNASRI.S",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		Label(emp1inf,text="Mr. PRAVEEN RAJU.K (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		Label(emp1inf,text="Ms. SHANMATHI.S(Head)",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
